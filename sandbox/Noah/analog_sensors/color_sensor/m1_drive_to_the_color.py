...
def drive_to_color(button_state, robot, color_to_seek):
    ...
    if button_state:
        ...
        if color_to_seek == ev3.ColorSensor.COLOR_NOCOLOR:
            color_index = 0
        elif color_to_seek == ev3.ColorSensor.COLOR_BLACK:
            color_index = 1
        elif color_to_seek == ev3.ColorSensor.COLOR_BLUE:
            color_index = 2
        elif color_to_seek == ev3.ColorSensor.COLOR_GREEN:
            color_index = 3
        elif color_to_seek == ev3.ColorSensor.COLOR_YELLOW:
            color_index = 4
        elif color_to_seek == ev3.ColorSensor.COLOR_RED:
            color_index = 5
        elif color_to_seek == ev3.ColorSensor.COLOR_WHITE:
            color_index = 6
        elif color_to_seek == ev3.ColorSensor.COLOR_BROWN:
            color_index = 7

        robot.left_motor_forward()
        robot.right_motor_forward()

        while not robot.color_sensor.color == color_index:
            time.sleep(0.01)
