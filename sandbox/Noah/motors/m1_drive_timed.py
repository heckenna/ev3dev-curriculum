...
#
#       speed_in_inches_per_second = 0.010283 * speed_in_degrees_per_second + 0
#
...
#       Time = Distance / (0.010283 * speed_in_degrees_per_second)
#
...
def main():
    ...
    while time_s != 0:
        spe = int(input("Enter a speed (0 to 900 dps): "))
        if spe == 0:
            break
        ...
        dist = int(input("Enter a distance to drive (inches): "))
        if dist == 0:
            break

        time_s = dist/(0.010283 * spe)
...
#   200 dps 24 inches (make sure it drives within 6 inches of the target distance) 28.75
